            ...
            <div class="tabs_content hide" id="tabs_content1">
                ...
                <div class="tabs_content hide" id="tabs_content2">
                    <div id="tab1" class="hide">
                        ...
                        <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                            <span class="hidden"></span>
                            <input data-filter-id="14" data-value-title="DFN1006-3H" data-id="filter[14][]_DFN1006-3H" type="checkbox" value="1001" name="filter[14][]">
                            <span class="checkboxIn">DFN1006-3H <small>15</small></span>
                        </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-23" data-id="filter[14][]_SOT-23" type="checkbox" value="1002" name="filter[14][]">
                    <span class="checkboxIn">SOT-23 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-26" data-id="filter[14][]_SOT-26" type="checkbox" value="1003" name="filter[14][]">
                    <span class="checkboxIn">SOT-26 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-323" data-id="filter[14][]_SOT-323" type="checkbox" value="1004" name="filter[14][]">
                    <span class="checkboxIn">SOT-323 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-363" data-id="filter[14][]_SOT-363" type="checkbox" value="1005" name="filter[14][]">
                    <span class="checkboxIn">SOT-363 <small>15</small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-523" data-id="filter[14][]_SOT-523" type="checkbox" value="1006" name="filter[14][]">
                    <span class="checkboxIn">SOT-523 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="SOT-89" data-id="filter[14][]_SOT-89" type="checkbox" value="1007" name="filter[14][]">
                    <span class="checkboxIn">SOT-89 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="TO-92" data-id="filter[14][]_TO-92" type="checkbox" value="1008" name="filter[14][]">
                    <span class="checkboxIn">TO-92 <small>32</small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                    <span class="hidden"></span>
                    <input data-filter-id="14" data-value-title="TO-93" data-id="filter[14][]_TO-93" type="checkbox" value="1009" name="filter[14][]">
                    <span class="checkboxIn">TO-93 <small></small></span>
                </span>
                            <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                            <span class="hidden"></span>
                    ...
                    <div class="tabs_content hide" id="tabs_content3">
                        <div id="tab1001" class="hide">
                            <div class="checkboxList ">
                        <span class="checkbox filter-checkbox" unselectable="on" style="user-select: none;">
                            <span class="hidden"></span>
                            <input data-filter-id="14" data-value-title="DFN1006-3H" data-id="filter[14][]_DFN1006-3H" type="checkbox" value="DFN1006-3H" name="filter[14][]">
